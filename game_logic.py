...
def fox_capacity(level):return min(15,3+2*max(0,int(level)-1))
def fox_upgrade_cost(level):return 500+max(0,int(level)-1)*3000
def fox_production_per_second(level):return round(0.89+(max(1,int(level))-1)*0.54,2)
